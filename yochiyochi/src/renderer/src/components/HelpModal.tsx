    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div>
            <h3 className="label-lg" style={{ color: 'var(--primary)', marginBottom: '4px' }}>Lessons</h3>
          ...
          <div>
            <h3 className="label-lg" style={{ color: 'var(--primary)', marginBottom: '4px' }}>{t('number', uiLanguage)}</h3>
            <p className="body-lg" style={{ opacity: 0.8, lineHeight: 1.5 }}>
