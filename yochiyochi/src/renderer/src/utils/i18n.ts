...
export const translations: Translations = {
  lessons: { ko: 'Lessons', en: 'Lessons', ja: 'レッスン' },
  ...
  learningPanel: { ko: '학습 설정 (LEARNING PANEL)', en: 'LEARNING PANEL', ja: '学習パネル' },
  scriptType: { ko: '문자 종류 (SCRIPT)', en: 'SCRIPT TYPE', ja: '文字の種類' },
  hiragana: { ko: '히라가나', en: 'Hiragana', ja: 'ひらがな' },
  katakana: { ko: '가타카나', en: 'Katakana', ja: 'カタカナ' },
  mixed: { ko: '혼합', en: 'Mixed', ja: '混合' },
  range: { ko: '학습 범위 (RANGE)', en: 'LEARNING RANGE', ja: '学習範囲' },
  ...
  displayOptions: { ko: '표시 옵션 (DISPLAY)', en: 'DISPLAY OPTIONS', ja: '表示オプション' },
  ...
  drawBtn: { ko: 'DRAW / 뽑기', en: 'DRAW', ja: '引く' },
  ...
  randomNumber: { ko: 'RANDOM NUMBER', en: 'RANDOM NUMBER', ja: 'ランダムな数字' },
  ...
  languageSettings: { ko: '언어 설정 (LANGUAGE)', en: 'LANGUAGE', ja: '言語設定' },
