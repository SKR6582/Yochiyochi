...
export const translations: Translations = {
  ...
  sidebarTip: {
    ko: 'TIP: 단어와 이미지는 한 번에 끄고 켤 수 있습니다.',
    en: 'TIP: You can toggle words and images at once.',
    ja: 'ヒント: 単語と画像を一度に切り替えられます。'
  },
  ...
  noHistory: {
    ko: '아직 뽑은 기록이 없습니다',
    en: 'No draw history yet',
    ja: 'まだ履歴がありません'
  },
  noHistorySub: {
    ko: 'Lessons 탭에서 글자를 뽑아보세요',
    en: 'Draw characters in the Lessons tab',
    ja: 'レッスンタブで文字を引いてみてください'
  },
  ...
  presetTip: {
    ko: 'TIP: 반 별로 프리셋을 만들어 결석자를 제외할 수 있습니다.',
    en: 'TIP: Create presets per class to exclude absentees.',
    ja: 'ヒント: クラスごとのプリセットを作成して欠席者を除外できます。'
  },
  ...
  NO_SELECTION: {
    ko: '학습 범위를 하나 이상 켜주세요.',
    en: 'Please turn on at least one learning range.',
    ja: '学習範囲を1つ以上オンにしてください。'
  },
  ...
  helpLessons: {
    ko: 'Lessons 탭에서는 설정한 범위 내에서 히라가나/가타카나를 무작위로 뽑을 수 있습니다.',
    en: 'In the Lessons tab, you can randomly draw characters within the set range.',
    ja: 'Lessonsタブでは、設定した範囲内で文字をランダムに引くことができます。'
  },
  helpWhiteboard: {
  ...
  helpHistory: {
    ko: '기록 탭에서는 지금까지 뽑은 글자들의 내역을 확인하고 다시 띄울 수 있습니다.',
    en: 'In the History tab, you can view the drawn characters and display them again.',
    ja: '履歴タブでは、これまでに引いた文字の履歴を確認し、再度表示できます。'
  },
  helpNumber: {
    ko: '숫자 탭에서는 반 별 프리셋을 만들어 결석자를 제외하고 무작위 숫자를 뽑을 수 있습니다.',
    en: 'In the Number tab, you can create presets per class to draw a random number excluding absentees.',
    ja: '数字タブでは、クラスごとのプリセットを作成し、欠席者を除外してランダムな数字を引くことができます。'
  },
  helpCards: {
    ko: '카드 탭에서는 모든 글자의 목록을 보고 원하는 글자를 클릭해 화면에 크게 띄울 수 있습니다.',
    en: 'In the Cards tab, you can view all characters and click to display them large.',
    ja: 'カードタブでは、すべての文字のリストを表示し、クリックして大きく表示できます。'
  },
  close: { ko: '닫기', en: 'Close', ja: '閉じる' },
  resetHistory: { ko: '뽑기 기록 초기화', en: 'Reset Draw History', ja: '履歴を初期化' },
  resetHistoryConfirm: {
    ko: '이 프리셋의 뽑기 기록을 초기화하시겠습니까?',
    en: 'Are you sure you want to reset the draw history for this preset?',
    ja: 'このプリセットの履歴を初期化しますか？'
  }
}
